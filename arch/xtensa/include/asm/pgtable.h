...
#if 1 && defined(CACHE_ALIASING_POSSIBLE) || defined(CONFIG_SMP)
#define _PAGE_BASE	 (_PAGE_VALID | _PAGE_CA_WT | _PAGE_ACCESSED | _PAGE_PRESENT) 
#else
...
// # define _PAGE_DIRECTORY (_PAGE_VALID | _PAGE_ACCESSED | _PAGE_CA_WT)
#else
